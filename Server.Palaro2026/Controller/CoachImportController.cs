...
public class CoachImportController : ControllerBase
{
    ...
    public async Task<IActionResult> UploadCoaches([FromForm] IFormFile? file, [FromForm] string? uploadedByUserId = null)
    {
        ...
        try
        {
            ...
            var result = await _importService.ImportCoachesFromExcelAsync(ms, userId);
